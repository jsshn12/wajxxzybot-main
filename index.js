...
//
const BotName = 'JXXZ BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/jxxzyshn/'; // Nama Instagramlu cok
const whatsapplu = '0813-7434-7075'; // Nomor whatsapplu cok
...
conn.sendMessage(id, 'Owner JXXZY wa.me/6281374347075' ,MessageType.text);
}
else if (text == 'donasi'){
conn.sendMessage(id, 'bisa dong?' ,MessageType.text);
}
else if (text == 'Anjing'){
...
else if (text == '#donatemanja'){
const corohelp = await get.get('https://sociabuzz.com/jxxzyshn/donate').json()
var date = new Date();
var tahun = date.getFullYear();
var bulan = date.getMonth();
var tanggal = date.getDate();
...
//Tolonglah bro jangan di ubah ubah CYBEROREN
